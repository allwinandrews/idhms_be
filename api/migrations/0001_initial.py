    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_info', models.CharField(blank=True, max_length=15, null=True, validators=[django.core.validators.RegexValidator(message='Enter a valid phone number in international format (e.g., +123456789).', regex='^\\+?[1-9]\\d{1,14}$')])),
                ...
                ('guardian_contact_info', models.CharField(blank=True, max_length=15, null=True)),
                ('guardian_relationship', models.CharField(blank=True, help_text='Relationship to the guardian.', max_length=50, null=True)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('guardian', models.ForeignKey(blank=True, help_text='Guardian user responsible for this account (for babies).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dependents', to=settings.AUTH_USER_MODEL)),
